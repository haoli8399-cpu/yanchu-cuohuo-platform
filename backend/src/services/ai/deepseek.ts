...
async function chat(m,t=512){
 let r=await fetch(BASE+"/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:*** "+KEY},body:JSON.stringify({model:"deepseek-chat",messages:m,max_tokens:t,temperature:0.7})});
